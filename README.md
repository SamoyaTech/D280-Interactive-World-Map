...
Built for WGU's D280 JavaScript Programming course, focused on using Angular, SVG assets, and REST APIs to add interactivity and data capabilities to a web application.
